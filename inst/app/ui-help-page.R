  ...
  column(width = 12, title = "Help",
         tabBox(width = 12,
                tabPanel("Data",
                         ...
                         "All human pathomics feature files must include the pseudonym in the filename either in the beginning as ", em("pseudonym_"), " or as ", em("_pseudonym_"), " in the middle of the file to be processed. All mouse pathomics feature files must include the ID as the full filname excluding", em("_1_features.csv"),
