...
ui <- shinydashboardPlus::dashboardPage(
  ...
  body = dashboardBody(
    ...
    tags$head(tags$style(".progress-bar {background-color: #3EB489}")),
    tags$head(tags$style(".selected {background-color: #3EB489 !important;}")),
    tags$head(tags$style(".dropdown-item.active {background-color: #3EB489 !important;}")),
    tags$head(tags$style(".irs--shiny .irs-bar {border-top: 1px solid #3EB489; border-bottom: 1px solid #3EB489; background: #3EB489}")),
    tags$head(tags$style(".irs--shiny .irs-from, .irs--shiny .irs-to, .irs--shiny .irs-single {background-color: #3EB489}")),
    tags$head(tags$style(".bootstrap-switch .bootstrap-switch-handle-on.bootstrap-switch-primary, .bootstrap-switch .bootstrap-switch-handle-off.bootstrap-switch-primary {background: #3EB489}")),
    tags$head(tags$style(".bootstrap-switch .bootstrap-switch-handle-on, .bootstrap-switch .bootstrap-switch-handle-off, .bootstrap-switch .bootstrap-switch-label {padding-right: 6px; padding-left: 6px}")),
    tags$head(tags$style(".btn-primary:focus {background-color: #3EB489}")),
    tags$head(tags$style(".btn-primary:active {background-color: #3EB489 !important}")),
    tags$head(tags$style(".btn-primary:active {border-color: #FFFFF !important}")),
    tags$head(tags$style(".btn-primary:focus {border-color: #3EB489}")),
    tags$head(tags$style(".btn-primary:hover {border-color: #37a17b}")),
    tags$head(tags$style(".label-default.bg-default {background-color: #3EB489 !important}")),
    tags$head(tags$style(".sidebar-menu li>a>.fa-angle-left {position: absolute; top: 53%;}")),
    tags$head(tags$style(".sidebar-menu .fas.pull-right.fa-angle-down {position: absolute; top: 35% !important; left: 85%}")),
